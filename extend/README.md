...
```ts
import * as originalStore from "@storage/deno-fs";
import { extendStore } from "@storage/extend";
...
```ts
import type { StoreTrait } from "@storage/extend/types";
...
import { copyItems } from "@storage/common/copy-items";
import { moveItems } from "@storage/common/move-items";
