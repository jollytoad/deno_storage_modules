...
Deno.test("getDenoKv() returns undefined when given @storage/deno-fs directly", async () => {
  try {
...
Deno.test("getDenoKv() returns Deno.Kv when given the delegate store backed by @storage/deno-kv", async () => {
  try {
...
Deno.test("getDenoKv() returns Deno.Kv when given the delegate store backed by @storage/deno-fs", async () => {
  try {
